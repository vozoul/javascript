...
il affiche un message d'erreur signifiant que la variable n'a pas ete defini
...
Pour cela reprenez votre datas_old.js issu de 10. Nous allons utiliser la page html fournie.
